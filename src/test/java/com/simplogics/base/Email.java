...
public class Email {
	public static  void email()throws EmailException {
		...
		final String username = "minnithottumkal1994@gmail.com"; //change to your Gmail username
	    final String password ="minni123";//change to your Gmail password
	    final String from ="minnithottumkal1994@gmail.com"; //change to from email address
	   ...
	   // final String cc = "test.cc.email@helloselenium.com"; //change to cc email address
	    ...
	    final String subject = "Extent Report and Logs of Atidee Automation"; //change to your subject
	    ...
	    try {
	       ...
	       // message.setRecipients(Message.RecipientType.CC,
	        ...
	        String fileName1 = "Extent.html"; //change to your attachment filename
	        ...
	        String file2 = System.getProperty("user.dir")+"/target/surefire-reports/html/Chromelog.log";	        		
	        String fileName2= "Chromelog.log"; //change to your attachment filename
