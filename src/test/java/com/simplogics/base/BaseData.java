...
public class BaseData extends Email {
	...
	public void setUp() {
		...
		if (driver == null) {
			...
			System.setProperty("webdriver.chrome.logfile", "/home/appus/eclipse-workspace/Atidee/target/surefire-reports/html/Chromelog.log");
	...
	public void tearDown(ITestResult result) throws Exception {
		if (test != null) {
			...
			if (result.getStatus() == ITestResult.FAILURE) {
				...
				test.log(Status.PASS, "Testcase success is " + result.getName());
